<header class="site-header" style="z-index: 100;">
  <div class="container-fluid">
    <a href="{{ route('home') }}" class="site-logo">
      <img class="hidden-md-down" src="{{ asset('app/img/logo-2.png') }}" alt="">
      <img class="hidden-lg-up" src="{{ asset('app/img/logo-2-mob.png') }}" alt="">
    </a>
        ...
        <div class="site-header-shown">
          ...
          <div class="dropdown dropdown-lang">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-menu-col">
                <a class="dropdown-item current" href="#"><span class="flag-icon flag-icon-br"></span>Português</a>
          ...
          <div class="dropdown user-menu">
            <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('app/img/avatar-2-64.png') }}" alt="">
                        </button>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
              ...
              <a class="dropdown-item" href="{{ route('sair') }}"><span class="font-icon glyphicon glyphicon-log-out"></span>Sair</a>
            </div>
          </div>
